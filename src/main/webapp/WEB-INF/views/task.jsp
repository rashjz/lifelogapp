<div th:fragment="task">
    ...
    <div ng-controller="taskManagerController">
        ...
        <div id="task-panel" class="fadein fadeout showpanel panel" style="margin-top: 7%" ng-show="toggle">
            ...
            <div class="panel-body">
                <div class="task" ng-repeat="task in tasks">
                    ...
                    <div class="action-checkbox">
                        <input id="{{task._links.self.href}}" type="checkbox" value="{{task._links.self.href}}" ng-checked="selection.indexOf(task._links.self.href) > -1"
        ...
        <div id="add-task-panel" class="fadein fadeout addpanel panel" style="margin-top: 7%" ng-hide="toggle">
            <div class="panel-heading">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/TaskController.js"></script>
