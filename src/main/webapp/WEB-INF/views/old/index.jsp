...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/webjars/angularjs/1.6.4/angular.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/webjars/angularjs/1.6.4/angular-route.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/webjars/angularjs/1.6.4/angular-resource.min.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/webjars/angularjs/1.6.4/angular-animate.js"></script>
    ...
    <style>
        body {
            background: url(${pageContext.request.contextPath}/resources/images/bg.jpg);
